...
results onto *KEGG* pathway diagrams.
...
We can now plot the differential expression statistics on the *hsa05207:
Chemical carcinogenesis - receptor activation* pathway. If not specified otherwise, the pathway
...
<p>Network image:</p>
<img src="{{ "/assets/img/pathways/network_Chemical_carcinogenesis_._receptor_activation_05207_hsa.svg" | relative_url }}"
width="1000">
<hr>
<p>Legend image:</p>
<img src="{{ "/assets/img/pathways/legend_Pleural_mesothelioma_WP5087_r140461_Homo_sapiens.svg" | relative_url }}"
